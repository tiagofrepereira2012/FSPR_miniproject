=====================================
- We're group 7 --> we'll need to present group mod(ourGroup+1, allGroups) --> group 1
- Data needs to be ready by May 8th
  - small report (also orally)
  - instructions to run the code + code itself
- presentation on may 15h (7 minutes --> 7 slides)

- keep training/testing protocol
- try at least two solutions
